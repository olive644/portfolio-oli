      ...
      <div className="relative mx-auto grid min-h-[calc(100svh-7rem)] max-w-6xl gap-12 px-5 pb-16 sm:px-8 lg:grid-cols-[1.35fr_0.65fr] lg:items-end lg:pb-24">
        <div>
          ...
          <div className="overflow-hidden py-2 [perspective:900px]">
            <div data-hero-title><TextReveal text="Sobre Mim" as="h1" fontSize="clamp(4.5rem, 12vw, 9.5rem)" staggerDelay={38} duration={360} easing="cubic-bezier(0.22, 1, 0.36, 1)" color="#f4f4f1" hoverColor="#858585" className="max-w-4xl font-sans" /></div>
          </div>
