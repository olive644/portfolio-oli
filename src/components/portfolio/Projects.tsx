    ...
    <section id="projetos" className="border-b border-border py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <Reveal className="grid gap-6 sm:grid-cols-[180px_1fr]">
          ...
          <div><TextReveal text="Projetos" as="h2" fontSize="clamp(4rem, 9vw, 7.5rem)" staggerDelay={44} duration={380} direction="down" color="#f4f4f1" hoverColor="#777" style={{ fontFamily: "var(--font-display)", fontWeight: 400, textTransform: "none", letterSpacing: "-0.045em" }} /><p className="mt-5 max-w-xl text-muted-foreground">Clique para espalhar os projetos. Arraste uma imagem para baixo para guardar tudo novamente.</p></div>
        </Reveal>
